...
public class Scenario<T> where T : new()
{
    ...
    public async Task RunAsync()
    {
        ...
        Task taskProduce2 = Task.Run(() => ProduceWithRandomDelay2(_iterations, _producerDelay));
        Task taskConsume2 = Task.Run(() => ConsumeWithRandomDelay2(_iterations, _consumerDelay));
    ...
    private async Task ProduceWithRandomDelay2(int iterations, int maxDelay)
    {
        Random rng = new Random();
        for (int i = 0; i < iterations; i++)
        {
    ...
    private async Task ConsumeWithRandomDelay2(int iterations, int maxDelay)
    {
        Random rng = new Random();
        for (int i = 0; i < iterations; i++)
        {
